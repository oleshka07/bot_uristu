...
def suggest_event_message(contact: models.Contact, event: models.LifeEvent) -> str:
    ...
    system = (
        ...
        "No clichés, NO emojis, match a warm friendly tone."
    )
    prompt = (
...
def build_style_card(sample: list[str]) -> str | None:
    ...
    system = (
        ...
        "вживає; довжина й ритм речень; привітання/прощання; пунктуація; "
        "тон (формальність, гумор); улюблені слова й фрази; чого НЕ робить. "
        "Пиши українською, це інструкція для копірайтера, який писатиме від її імені."
    )
...
def draft_reply(contact: models.Contact, incoming_text: str) -> str | None:
    ...
    system = (
        ...
        "в історії та копіюй його стиль, лексику та довжину речень. "
        "НЕ використовуй емодзі/смайлики у відповідях (без смайликів). "
...
def draft_outreach(contact: models.Contact, reason: str) -> str | None:
    ...
    system = (
        ...
        "сам — дивись на його репліки в історії і копіюй стиль та лексику. "
        "НЕ використовуй емодзі/смайлики (без смайликів). "
        "1–3 речення, тепло і природно, без формальностей і без "
...
def refine_reply(
    ...
    system = (
        ...
        "НЕ використовуй емодзі/смайлики у повідомленні. "
